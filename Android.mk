...
$(KERNEL_ZIMAGE_OUT): PRIVATE_BAZEL_EXPORT_ENV := BAZEL_DO_NOT_DETECT_CPP_TOOLCHAIN=1 DEFCONFIG_OVERLAYS="$(KERNEL_DEFCONFIG_OVERLAYS)" KERNEL_VERSION=$(LINUX_KERNEL_VERSION)  WT_FINAL_RELEASE=$(WT_FINAL_RELEASE) WT_COMPILE_FACTORY_VERSION=$(WT_COMPILE_FACTORY_VERSION) WT_COMPILE_TARGET_PRODUCT_NAME=$(WT_COMPILE_TARGET_PRODUCT_NAME)
