...
{
	struct mtk_drm_crtc *mtk_crtc = NULL; //Peridot-1381,zhangshaoxiong1.wt,modify,20240328,slove parameter comp null pointer error
	struct mtk_drm_private *priv = NULL;
	//+Peridot-1381,zhangshaoxiong1.wt,modify,20240328,slove parameter comp null pointer error
