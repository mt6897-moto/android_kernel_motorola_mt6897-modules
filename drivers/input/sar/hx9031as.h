...
#define HX9031AS_TEST_CHS_EN 0             //开机打开所有通道，仅在测试阶段用(也有客户要求开机默认通道全开)
#define HX9031AS_REPORT_EVKEY 0            //选择上报事件类型1==EV_KEY, 0==EV_ABS
#define HX9031AS_TEST_ON_MTK_DEMO_XY6761 0 //仅在6761开发板调试时置1
...
static struct hx9031as_addr_val_pair hx9031as_reg_init_list[] = {
    ...
    {RW_82_PROX_HIGH_DIFF_CFG_CH1_0,   0x09},
    ...
    {RW_8A_PROX_LOW_DIFF_CFG_CH1_0,    0x08},
	...
	{RW_98_DSP_CONFIG_CTRL11,          0x1D},
	{RW_A0_LP_OUT_DELTA_THRES_CH1_CFG0,0x03},
	{RW_AD_BL_IN_NO_UP_NUM_SEL0,       0x50},
	{RW_94_DSP_CONFIG_CTRL7,           0x3B},
	{RW_C3_DSP_CONFIG_CTRL0,           0xFF},
	{RW_92_DSP_CONFIG_CTRL5,           0x11},
