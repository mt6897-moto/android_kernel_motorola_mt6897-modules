...
#define HX9035_ON_BOARD 0
#define HX9036_ON_BOARD 1
#define HX9036_CHIP_SELECT HX9036_ON_BOARD
#define HX9036_DRIVER_NAME "hx9036" //i2c addr: HX9036=0x1B

#define TYHX_DELAY_US(x) msleep((x)/1000)
#define TYHX_DELAY_MS(x) msleep(x)
#define HX9036_TEST_CHS_EN 0             //开机打开所有通道，仅在测试阶段用(也有客户要求开机默认通道全开)
#define HX9036_REPORT_EVKEY 0 //选择上报事件类型report 1:EV_KEY 0:EV_ABS

#define ID_VALUE_REV3 0x2E
#define HX9036_CH_NUM 8
#define HX9036_MAX_XFER_SIZE 32

#define HX9036_ODR_MS 200

#define HX9036_DATA_LOCK 1
#define HX9036_DATA_UNLOCK 0

#define CH_DATA_2BYTES 2
#define CH_DATA_3BYTES 3
#define CH_DATA_BYTES_MAX CH_DATA_3BYTES

#define HX9036_ID_CHECK_COUNT 2
#define HX9036_CHIP_ID ID_VALUE_REV3
...
#define HX9036_THR_FAR_COE_1_2 500/1000  //(此处务必不要带括号!)
#define HX9036_THR_FAR_COE_3_4 750/1000
#define HX9036_THR_FAR_COE_7_8 875/1000
#define HX9036_THR_FAR_COE_1_1 1000/1000

//{======================================== hx9036 registers Begin

#define HX9036_REG_PAGE 0x00 //address for page select
...
//============================================hx9036 registers END}

struct hx9036_near_far_threshold {
    int16_t thr_near;
    int16_t thr_far;
};

struct hx9036_addr_val_pair {
    uint16_t addr;
    uint8_t val;
};

struct hx9036_channel_info {
    char name[20];
    bool enabled;
    bool used;
    int state;
...
struct hx9036_platform_data {
    struct device *pdev;
    struct delayed_work polling_work;
    struct input_dev *input_dev_key;
    struct hx9036_channel_info *chs_info;
    uint32_t channel_used_flag;
    int irq;
    int irq_gpio;
    char irq_disabled;
    uint32_t prox_state_reg;//寄存器显示的prox状态
    bool sel_bl[HX9036_CH_NUM];
    bool sel_raw[HX9036_CH_NUM];
    bool sel_diff[HX9036_CH_NUM];
    bool sel_lp[HX9036_CH_NUM];
...
static struct hx9036_addr_val_pair hx9036_reg_init_list[] = {
    ...
    {PAGE0_4F_TC_NOSR_CFG1,              0x30},
    {PAGE0_50_TC_NOSR_CFG2,              0x30},
    {PAGE0_51_TC_NOSR_CFG3,              0x33},
    {PAGE0_52_TC_AVG_CFG0,               0x42},
    {PAGE0_53_TC_AVG_CFG1,               0x40},
    {PAGE0_54_TC_AVG_CFG2,               0x30},
    {PAGE0_55_TC_AVG_CFG3,               0x44},

    {PAGE0_78_RANGE_CFG_0,               0x77}, //ch1 ch0 ： (N+1)* 1.25pF
    {PAGE0_79_RANGE_CFG_1,               0x77}, //ch3 ch2
    {PAGE0_7A_RANGE_CFG_2,               0x00}, //ch5 ch4
    {PAGE0_7B_RANGE_CFG_3,               0x77}, //ch7 ch6 json config available last line.

    {PAGE0_83_AMP_CHOP_CFG,              0x00}, //ch7 ch6 json config available last line.

    {PAGE0_95_DSP_CONFIG_CTRL2,          0xff},
    {PAGE0_9A_DSP_CONFIG_CTRL7,          0x00}, // 1: diff_data; 0: lp
    {PAGE0_9B_DSP_CONFIG_CTRL8,          0xFF}, // 1: bl; 0: raw
    {PAGE0_9C_DSP_CONFIG_CTRL9,          0xa0}, // high 4 byte (n+1)*(-2048)
    {PAGE0_9D_CAP_INI_CFG0,              0xb4},

    {PAGE0_A1_INTERRUPT_CFG1,            0x00}, //INT_RDY_EN
    {PAGE0_A2_INTERRUPT_CFG2,            0xff}, //INT_PROX_LOW1_EN
    {PAGE0_A3_INTERRUPT_CFG3,            0x00}, //INT_PROX_LOW2_EN
    {PAGE0_A5_INTERRUPT_CFG5,            0xff}, //INT_PROX_HIGH1_EN
    {PAGE0_A6_INTERRUPT_CFG6,            0x00}, //INT_PROX_HIGH2_EN

    {PAGE0_AB_PROX_INT_CFG,              0x11}, //7:4 PROX_INT_HIGH_NUM  3:0 PROX_INT_LOW_NUM
    {PAGE0_AC_BL_UP_CFG0,                0x77},
    {PAGE0_AD_BL_UP_CFG1,                0x77},
    {PAGE0_AE_BL_UP_CFG2,                0x77},
    {PAGE0_AF_BL_UP_CFG3,                0x77},
    {PAGE0_B0_BL_DN_CFG0,                0x11},
    {PAGE0_B1_BL_DN_CFG1,                0x11},
    {PAGE0_B2_BL_DN_CFG2,                0x11},
    {PAGE0_B3_BL_DN_CFG3,                0x11},

    {PAGE0_B9_CH0_COE_CFG_0,             0x3b},
    {PAGE0_BB_CH1_COE_CFG_0,             0x3b},
    {PAGE0_BD_CH2_COE_CFG_0,             0x3b},
    {PAGE0_BF_CH3_COE_CFG_0,             0x3b},
    {PAGE0_C1_CH4_COE_CFG_0,             0x3b},
    {PAGE0_C3_CH5_COE_CFG_0,             0x3b},
    {PAGE0_C5_CH6_COE_CFG_0,             0x1e},
    {PAGE0_C7_CH7_COE_CFG_0,             0x3b},

    {PAGE0_B5_LP_ALP_CFG0,               0x33},
    {PAGE0_B6_LP_ALP_CFG1,               0x33},
    {PAGE0_B7_LP_ALP_CFG2,               0x33},
    {PAGE0_B8_LP_ALP_CFG3,               0x33},

    {PAGE0_C9_PROX_HIGH_THRES1_CFG0,     0x0c}, //PROX_HIGH_THRES1
    {PAGE0_CA_PROX_HIGH_THRES1_CFG1,     0x0c},
    {PAGE0_CB_PROX_HIGH_THRES1_CFG2,     0x0c},
    {PAGE0_CC_PROX_HIGH_THRES1_CFG3,     0x0c},
    {PAGE0_CD_PROX_HIGH_THRES1_CFG4,     0x0c},
    {PAGE0_CE_PROX_HIGH_THRES1_CFG5,     0x0c},
    {PAGE0_CF_PROX_HIGH_THRES1_CFG6,     0x0c},
    {PAGE0_D0_PROX_HIGH_THRES1_CFG7,     0x0c},
    {PAGE0_D1_PROX_HIGH_THRES2_CFG0,     0x10},//PROX_HIGH_THRES2
    {PAGE0_D2_PROX_HIGH_THRES2_CFG1,     0x10},
    {PAGE0_D3_PROX_HIGH_THRES2_CFG2,     0x10},
    {PAGE0_D4_PROX_HIGH_THRES2_CFG3,     0x10},
    {PAGE0_D5_PROX_HIGH_THRES2_CFG4,     0x10},
    {PAGE0_D6_PROX_HIGH_THRES2_CFG5,     0x10},
    {PAGE0_D7_PROX_HIGH_THRES2_CFG6,     0x10},
    {PAGE0_D8_PROX_HIGH_THRES2_CFG7,     0x10},

    {PAGE0_E1_DITHER_CFG,                0x01}, //freq
    {PAGE0_E2_SAMPLE_NUM_0,              0x50},
    {PAGE0_E3_SAMPLE_NUM_1,              0x00},
    {PAGE0_E4_INTEGRATION_NUM_0,         0x50},
    {PAGE0_E5_INTEGRATION_NUM_1,         0x00},
    {PAGE0_ED_LPOUT_DELTA_CFG,           0x55}, //1: close usefilter

    {PAGE1_A3_LP_OUT_DELTA_THRES_CH1_CFG0,      0x30},
    {PAGE1_A4_LP_OUT_DELTA_THRES_CH1_CFG1,      0x00},
    {PAGE1_A9_LP_OUT_DELTA_THRES_CH3_CFG0,      0x30},
    {PAGE1_AA_LP_OUT_DELTA_THRES_CH3_CFG1,      0x00},
    {PAGE1_AF_LP_OUT_DELTA_THRES_CH5_CFG0,      0x30},
    {PAGE1_B0_LP_OUT_DELTA_THRES_CH5_CFG1,      0x00},
    {PAGE1_B5_LP_OUT_DELTA_THRES_CH7_CFG0,      0x30},
    {PAGE1_B6_LP_OUT_DELTA_THRES_CH7_CFG1,      0x00},
    {PAGE1_C0_BL_IN_NO_UP_NUM_SEL0,      0x55},
    {PAGE1_C1_BL_IN_NO_UP_NUM_SEL1,      0x55},
    {PAGE1_C2_BL_IN_NO_UP_NUM_SEL2,      0x55},
    {PAGE1_C3_BL_IN_NO_UP_NUM_SEL3,      0x55},

    {PAGE1_E1_PROX_LOW_THRES1_CFG0,      0x01},
    {PAGE1_E2_PROX_LOW_THRES1_CFG1,      0x03},
    {PAGE1_E3_PROX_LOW_THRES1_CFG2,      0x01},
    {PAGE1_E4_PROX_LOW_THRES1_CFG3,      0x03},
    {PAGE1_E5_PROX_LOW_THRES1_CFG4,      0x01},
    {PAGE1_E6_PROX_LOW_THRES1_CFG5,      0x03},
    {PAGE1_E7_PROX_LOW_THRES1_CFG6,      0x01},
    {PAGE1_E8_PROX_LOW_THRES1_CFG7,      0x03},

    {PAGE1_C4_LP_SIGN_THRES_EN,          0xaa},
    {PAGE1_C5_LP_SIGN_THRES_CH0,         0x90},
    {PAGE1_16_REG_TO_ANA2,               0xc0}, //CS/INT复用配置
    {PAGE1_17_REG_TO_ANA3,               0x00}, //配置CS3引脚为INT功能
    {PAGE1_1C_REG_TO_ANA8,               0xc0},
    {PAGE2_FC_CH_SUB_CFG,                0x0b},
