...
bool need_write_charger_state_flag = false;
...
extern void get_tp_info(void);//P98300AA1-2658,fangzhihua.wt,add,20240228, add tp info
...
//+peridot-2133,fangzhihua.wt ,change,20240419, fix for TP chanrging state
	ts->fw_update_stat = 1;
	need_write_charger_state_flag = true;
...
void Boot_Update_Firmware(struct work_struct *work)
{
	...
	//-P98300AA1-2658,fangzhihua.wt,change,20240304, distinguish 1st add 2nd  tp firmware
	get_tp_info();//P98300AA1-2658,fangzhihua.wt,add,20240228, add tp info
