...
/*[TXD TMBV70A] & [LCE LED790AM] modules releated*/
#define INITIALIZE_SETTING_REGISTER_NUM 4
...
static int gt9772b_init(struct gt9772b_device *gt9772b)
{
	...
	register_setting(client, g_vcmconfig.wr_table, INITIALIZE_SETTING_REGISTER_NUM);

	ret = i2c_smbus_read_byte_data(client, 0x0b);
	// LOG_INF("reg 0x0b value: %x\n", ret);
	ret = i2c_smbus_read_byte_data(client, 0x02);
	// LOG_INF("reg 0x02 value: %x\n", ret);
	ret = i2c_smbus_read_byte_data(client, 0x06);
	// LOG_INF("reg 0x06 value: %x\n", ret);
	ret = i2c_smbus_read_byte_data(client, 0x07);
	// LOG_INF("reg 0x07 value: %x\n", ret);
...
static long gt9772b_ops_core_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	int ret = 0;
	struct gt9772b_device *gt9772b = sd_to_gt9772b_vcm(sd);
...
static const struct v4l2_subdev_core_ops gt9772b_ops_core = {
	.ioctl = gt9772b_ops_core_ioctl,
};

static const struct v4l2_subdev_ops gt9772b_ops = {
	.core = &gt9772b_ops_core,
};
