...
static const struct fsa4480_reg_val fsa_reg_i2c_defaults[] = {
	{FSA4480_SLOW_L, 0xAF},
	{FSA4480_SLOW_R, 0xAF},
	{FSA4480_SLOW_MIC, 0xAF},
	{FSA4480_SLOW_SENSE, 0xAF},
	{FSA4480_SLOW_GND, 0xAF},
...
static const struct fsa4480_reg_val fsa_reg_i2c_bct[] = {
	{FSA4480_SLOW_L, 0xFF},
	{FSA4480_SLOW_R, 0xFF},
	{FSA4480_SLOW_MIC, 0xFF},
	{FSA4480_SLOW_SENSE, 0xFF},
	{FSA4480_SLOW_GND, 0xFF},
	{FSA4480_DELAY_L_R, 0x00},
	{FSA4480_DELAY_L_MIC, 0x00},
	{FSA4480_DELAY_L_SENSE, 0x00},
	{FSA4480_DELAY_L_AGND, 0x00},
...
int fsa4480_switch_event(enum fsa_function event)
{
	...
	case FSA_TYPEC_ACCESSORY_AUDIO:
		...
		if(fsa_priv->vendor == DIO4480){
			msleep(900);
			pr_err("DIO4480 Delay 900ms\n");
		} else {
			pr_err("BCT4480 Do nothing\n");
			}
		break;
...
static void fsa4480_update_reg_bct(struct regmap *regmap)
{
	u8 i;
	int ret;
	...
	for (i = 0; i < ARRAY_SIZE(fsa_reg_i2c_bct); i++)
		ret = regmap_write(regmap, fsa_reg_i2c_bct[i].reg,
				   fsa_reg_i2c_bct[i].val);
}
			 ...
			 const struct i2c_device_id *id)
{
	...
	if (BCT4480_DEVICE_REG_VALUE == reg_value) {
		...
		fsa4480_update_reg_bct(fsa_priv->regmap);
	} else {
