...
static const struct usb_device_id mtk_usb_quirk_list[] = {
	...
	{USB_DEVICE(0x2109, 0x8817), .driver_info = USB_QUIRK_IGNORE_REMOTE_WAKEUP|USB_QUIRK_RESET|USB_QUIRK_DELAY_CTRL_MSG},
	{USB_DEVICE(0x0b95, 0x1790), .driver_info = USB_QUIRK_IGNORE_REMOTE_WAKEUP|USB_QUIRK_RESET|USB_QUIRK_DELAY_CTRL_MSG},
