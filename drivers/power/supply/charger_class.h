...
struct chgdev_notify {
	bool vbusov_stat;
	bool dpdmov_stat;
	bool qc20_vbus_ovp_en; //+PERIDOT-2894, yangpingao.wt, 20240423, mod, qc2.0 detect logic
};
...
struct charger_ops {
	...
	int (*set_shipping)(struct charger_device *dev, u32 val);
	//-PERIDOT-203, liyiying.wt, mod, 20240313, add aidl shipmode interface

	//+PERIDOT-583, yangpingao.wt, 20240413, mod, enable ovp mos by dvchg
	int (*typec_mux_otg_enable)(struct charger_device *dev, bool en);
	//-PERIDOT-583, yangpingao.wt, 20240413, mod, enable ovp mos by dvchg

	//+PERIDOT-2894, yangpingao.wt, 20240423, mod, qc2.0 detect logic
	int (*reset_qc20_ta)(struct charger_device *dev);
	int (*set_fast_charging_status)(struct charger_device *dev, bool en);
	//-PERIDOT-2894, yangpingao.wt, 20240423, mod, qc2.0 detect logic

	//+PERIDOT-7084, yangpingao.wt, 20240502, mod, disable batt ircomp
	int (*set_bat_ircomp)(struct charger_device *dev, bool en);
	//+PERIDOT-7084, yangpingao.wt, 20240502, mod, disable batt ircomp
};
...
//+PERIDOT-203, liyiying.wt, mod, 20240313, add aidl shipmode interface
extern int charger_dev_set_shipping_mode(struct charger_device *chg_dev, u32 val);
//-PERIDOT-203, liyiying.wt, mod, 20240313, add aidl shipmode interface

//+PERIDOT-583, yangpingao.wt, 20240413, mod, enable ovp mos by dvchg
extern int charger_dev_typec_mux_otg_enable(struct charger_device *chg_dev, bool en);
//+PERIDOT-583 yangpingao.wt, 20240413, mod, enable ovp mos by dvchg

//+PERIDOT-2894, yangpingao.wt, 20240423, mod, qc2.0 detect logic
extern int charger_dev_reset_qc20_ta(struct charger_device *charger_dev);
extern int charger_dev_set_fast_charging_status(struct charger_device *chg_dev, bool en);
//-PERIDOT-2894, yangpingao.wt, 20240423, mod, qc2.0 detect logic
