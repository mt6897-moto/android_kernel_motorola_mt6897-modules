			      ...
			      const struct pwm_state *state)
{
	...
	pr_debug("%s rate[%llx] clk_div[%u] div[%llx] high_width[%u] value[%u] period[%u]",
...
//+Peridot-32,zhangshaoxiong1.wt,modify,20240205,set backlight to pwm
static const struct mtk_pwm_data mt6897_pwm_data = {
	.enable_mask = BIT(0),
	.con0 = 0x18,
	.con0_sel = 0x0,
	.con1 = 0x1c,
...
static const struct of_device_id mtk_disp_pwm_of_match[] = {
	...
	{ .compatible = "mediatek,mt6897-disp-pwm", .data = &mt6897_pwm_data}, //Peridot-32,zhangshaoxiong1.wt,modify,20240205,set backlight to pwm
	{ }
};
