...
//+PERIDOT-426, mashaokang.wt, modify, 20240309, increase temperature rise limiting gear
static const int master_charger_state_to_current_limit[CHARGER_STATE_NUM] = {
	-1, 7000000, 6000000, 5000000, 4000000, 3000000, 1900000, 1600000, 1500000, 1300000, 1000000, 800000,  0
};
static const int slave_charger_state_to_current_limit[CHARGER_STATE_NUM] = {
	-1, 7000000, 5000000, 4000000, 3000000, 2400000, 1900000, 1600000, 1500000, 1300000, 1000000, 800000,  0
//-PERIDOT-426, mashaokang.wt, modify, 20240309, increase temperature rise limiting gear
};
