...
enum{
	...
	HARDWARE_CHARGER_IC_SLAVE_INFO,  //+Peridot-35,xiaohongyu,wt,add,20240223,add CHARGE IC message in factory mode
...
#define HARDWARE_HALL2_GET                          _IOWR(HARDWARE_ID, 0x91, char[HARDWARE_MAX_ITEM_LONGTH])     //add hall2 sensor name
