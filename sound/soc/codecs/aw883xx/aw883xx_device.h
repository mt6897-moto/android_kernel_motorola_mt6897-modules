...
struct aw_chanslot_desc {
	unsigned int rxlslot_reg;
	unsigned int rxlslot_mask;
	unsigned int rxlslot0;
	unsigned int rxlslot1;
	unsigned int rxlslot2;
	unsigned int rxlslot3;
};
...
struct aw_device {
	...
	struct aw_chanslot_desc chanslot_desc;
