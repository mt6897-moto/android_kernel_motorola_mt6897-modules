...
int aw883xx_pid_2049_dev_init(struct aw_device *aw_pa)
{
	...
	aw_pa->chanslot_desc.rxlslot_reg = AW_PID_2049_I2SCFG1_REG;
	aw_pa->chanslot_desc.rxlslot_mask = AW_PID_2049_I2S_RXL_SLOTVLD_MASK;
	aw_pa->chanslot_desc.rxlslot0 = AW_PID_2049_I2S_RXL_SLOTVLD_SLOT_0_VALUE;
	aw_pa->chanslot_desc.rxlslot1 = AW_PID_2049_I2S_RXL_SLOTVLD_SLOT_1_VALUE;
	aw_pa->chanslot_desc.rxlslot2 = AW_PID_2049_I2S_RXL_SLOTVLD_SLOT_2_VALUE;
	aw_pa->chanslot_desc.rxlslot3 = AW_PID_2049_I2S_RXL_SLOTVLD_SLOT_3_VALUE;
